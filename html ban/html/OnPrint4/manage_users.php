            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <a href="edit.php?id=<?php echo $row['userID'] ?>" class="link-dark"><i class="fa-solid fa-pen-to-square
        fs-5 me-3"></i></a>
                            <a href="delete.php?id=<?php echo $row['userID'] ?>" class="link-dark"><i class="fa-solid fa-trash fs-5"></i></a>
                        </td>
