...
<!-- end header -->
		...
		<form method="POST" action="updatedb.php">
			...
			<div class="contentleft">
				...
				<br><label>Delivery Address</label><br>
			...
			<div class="contentright">
				...
				<input type ="text" name="totalPayment" maxlength="50" class="inputbox"><br><br>
				...
				<a href="receipt.php"><input type="submit" class="button" value="MAKE UPDATE"></a>
