...
<a href="index.php"><img id="logo" src="../media/onp logo.png" alt="Logo"></a>
  ...
  <div class="body-container d-flex">
    <div class="welcome">
	<h4> <i class="fas fa-user-secret"></i> <?=$_SESSION['username'] ?></h4>
...
<img src="../Media/admin.jpg" alt="background image" class="repeat-no repeat" style="width: 1000px; height: 1000px; margin: auto; display:block;">
