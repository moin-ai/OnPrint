...
<body class="body-with-footer">
    ...
    <div class="title title-light justify-content-center fs-3 mb-5 bg-image" style="background-color:aquamarine;">
        <h1>
        ...
        <table class="table table-hover text-center">
            ...
            <tbody>
                <?php
                include "../db_conn.php";
                $sql = "SELECT registered_user.*, city.CityName, state.StateName FROM registered_user 
                ...
                ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="edit.php?userID=<?php echo $row['userID'] ?>" class="link-dark"><i class="fa-solid fa-pen-to-square
                        fs-5 me-3"></i></a>
