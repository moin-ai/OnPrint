...
if(isset($_POST['submit'])){
    ...
    $sql = "INSERT INTO `rider`(`userID`, `R_licensetype`, `R_available`) 
    VALUES ('$userID','$R_licensetype','$R_available')";
...
<div class="container">
    ...
    <div class="row mb-3">
        <div class="col">
            ...
            <input type="text" class="form-control" name="R_licensetype" placeholder="Professional">
        </div>
    </div>
