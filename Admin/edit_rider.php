...
if(isset($_POST['submit'])){
    ...
    $sql = "UPDATE rider SET `userID`='$userID', `R_licensetype`='$R_licensetype', `R_available`='$R_available' 
    WHERE `userID`='$userID'";
    ...
    if($result){
        header("Location: manage_riders.php?msg=New Record Created Successfully!!!");
    }
    else
...
<div class="container">
    <div class="text-center mb-4">
        <h3>Add New Rider</h3>
        <p class="text-muted">Please Fill The Form To Add A New Rider</p>
    </div>
    <?php 
...
?>
    ...
    <div class="row mb-3">
        <div class="col">
            <label class="form-lebel">License Type:</label>&nbsp;
            <input type="text" class="form-control" name="R_licensetype" value="<?php echo $row['R_licensetype'] ?>">
        </div>
    </div>

    <div class="mb-3">
        <label class="form-lebel">Rider Availability</label>
