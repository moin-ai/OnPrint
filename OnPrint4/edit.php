...
<div class="container">
    <div class="text-center mb-4">
        ...
        <p class="text-muted">Click Update to save the changes</p>
    </div>

    <?php
    //connect to the database
    $conn = mysqli_connect('localhost:3307','root','','onprint');

    //query to select all data from the onprint table
    $query = "SELECT * FROM onprint";
    $result = mysqli_query($conn, $query);

    //loop through the result set and display the data in the form fields
