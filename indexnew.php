    ...
    <div id="indicator"></div>
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Commission Fee</h3> </div>
            ...
            <div class="container-fluid">
                <!-- Start Page Content -->
                        ...
                        <div class="card card-outline-primary">
                            ...
                            <div class="card-body">
                                <form method='post'  action="add_comm.php">
                                    <div class="form-body">
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="C_ID" class="form-control" placeholder="xxxxx">
                                                   </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
                                                <div class="form-group has-danger">
                                                    ...
                                                    <input type="text" name="DeliveryID" class="form-control form-control-danger" placeholder="xxx-xx-xxx">
                                                    </div>
                                            </div>
                                            <!--/span-->
                                        </div>
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="C_rate" class="form-control" placeholder="Price per kilometer">
                                                   </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
                                                <div class="form-group has-danger">
                                                    ...
                                                    <input type="date" name="C_date" class="form-control form-control-danger" placeholder="date">
                                                    </div>
                                            </div>
                                            <!--/span-->
                                        </div>
                                    ...
                                    <div class="form-actions">
                                       <button type="submit" name="submit">Submit</button>
                                        <a href="/interfaceTEST/onprint/list_comm_new.php" class="btn btn-inverse">Cancel</a>
                                    </div>
                                </form>
                            </div>
                        </div>
