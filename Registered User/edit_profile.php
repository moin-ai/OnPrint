...
if(isset($_POST['submit'])){
    ...
    $sql = "UPDATE registered_user SET U_name='$U_name', U_address='$U_address', U_telephone='$U_telephone', City_ID='$City_ID', State_ID='$State_ID' WHERE userID='$userID'";
...
<h1><center>EDIT PROFILE</center> </h1></div>
...
if (!empty($_GET['userID'])) {
    $userID = $_GET['userID'];
    $stmt = $conn->prepare("SELECT * FROM registered_user WHERE userID = ? LIMIT 1");
